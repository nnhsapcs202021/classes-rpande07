...
public class CaesarCipher
{
    ...
    /**
     * Returns a string that describes the average time to crack the cipher, in several
     *		formats, based on the specific number of seconds per guess.
     *      
     ...
     *      an object (e.g., CaesarCipher.generateKeyphrase(7);)
     ...
     *  @return	a pseudorandom keyphrase of the specified length in characters
     */
